function program1(I, J)
% Funkcija PROGRAM1 na območju I x J naključno izbira točke. Dve zaporedoma
% izbrani točki poveže z daljico. Tako nariše poligonsko črto. Program se
% konča, če poligonska črta seka samo sebe. Tedaj izračuna ogljišča lika,
% ki ga najprej zapre, če upoštevamo, da se t veča od 0 do 1, se točka na zadnji
% daljici premika od ene točke do druge. V tem primeru tvorimo preproste
% mnogokotnike. Lik se na koncu obarva. Program vrne tudi njegovo ploščino.
